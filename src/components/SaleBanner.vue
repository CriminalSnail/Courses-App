<template>
   <aside class="mt-5 w-auto   mx-5 gap-4 items-center xl:mx-7  ">
      <header class="bg-cont w-full flex justify-center rounded-md py-2.5   gap-6 items-center  xl:py-3">
        <h1 class="text-white text-sm leading-5 xl:text-lg">Free Courses 🌟 Sale Ends Soon, Get It Now</h1>
        <button name="View items">
          <svg class="w-5 h-5 xl:w-6 xl:h-6"
